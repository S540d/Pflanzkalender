...
## Offene Issues (Stand 2026-09-02)

**Status (2026-09-02):** main = testing = **v1.6.1** (Stand nach PR #236, `63e5fb4`). `appVersionCode` in `twa-manifest.template.json` steht auf **19** (nächster Play-Store-Upload, deckt R8-Optimierung + Ausrichtung ab). 384 Tests grün, `tsc --noEmit` sauber.
...
## Letzte Merges / Fixes (2026-09-02)
