...
**Stand 2026-05-20:** User-Feedback (Issue #104, PR #107) + Lint Fix (Issue #108, PR #111) + AgendaScreen-Lokalisierung (PR #115) + i18n-Test + Roadmap abgeschlossen (PR #116) gemergt.

- **main branch:** v1.3.1 mit Phase 1 + Phase 2 (vollständig, inkl. Icon-Resizing) + Phase 3 (301 Tests) + Phase 4a (ESLint 9, Prettier) + Phase 4b (Expo Router) + Phase 5 (TWA-Manifest) + Issue #56 Phase 3 (TypeScript-Cleanup, `TouchableWebProps`, Duplikat-Beseitigung) + Klima-Reiter (Issue #55, PR #80) + Splash Screen (Issue #99, PR #106) + User-Feedback (Issue #104, PR #107) + AgendaScreen-Lokalisierung (PR #115)
...
| Was                                         | Wann       | Details                                                                                                                                                 |
| ------------------------------------------- | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **PR #116:** AgendaScreen i18n + Roadmap    | 2026-05-20 | ✅ main `438abdf`: EN-Regressionstest (`Tomaten`→`Tomatoes`), Phase 4b/5 ✅, Roadmap Issue #47 abgeschlossen                                            |
