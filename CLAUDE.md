...
**Stand 2026-05-19:** Splash Screen (Issue #99, PR #106) gemergt. Issue #108 (Lint & Format Check) gelöst – ESLint-Warnings 45 → 0 (PR #111 gemergt).
...
| Was                                         | Wann       | Details                                                                                                                                                         |
| ------------------------------------------- | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **PR #111:** Issue #108 – Lint Fix          | 2026-05-19 | ✅ main `61125aa`: ESLint-Warnings 45 → 0 (allow console.error/warn, fix unused vars/types, useCallback für exhaustive-deps, test-file-override for no-console) |
